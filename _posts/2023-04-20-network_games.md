...
_This post is based on the paper [Learning to infer the structure of network games](https://arxiv.org/abs/2206.08119)<d-cite key="rossi2022networkgames"></d-cite>, a collaboration with [Federico Monti](https://scholar.google.it/citations?user=NUdNFucAAAAJ&hl=it), [Yan Leng](https://yleng.github.io/www/), and [Xiaowen Dong](https://eng.ox.ac.uk/people/xiaowen-dong/). The same blog post has been also published on [Medium](https://medium.com/data-science/learning-network-games-29970aee44bb)._
